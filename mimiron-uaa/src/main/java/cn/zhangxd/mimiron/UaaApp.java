package cn.zhangxd.mimiron;

import cn.zhangxd.mimiron.core.config.MimironConstants;
import cn.zhangxd.mimiron.config.ApplicationProperties;
import cn.zhangxd.mimiron.config.DefaultProfileUtil;
...
public class UaaApp {
    ...
    public void initApplication() {
        ...
        if (activeProfiles.contains(MimironConstants.SPRING_PROFILE_DEVELOPMENT) && activeProfiles.contains(MimironConstants.SPRING_PROFILE_CLOUD)) {
