...
public class MetricsConfiguration extends MetricsConfigurerAdapter {
    ...
    public MetricsConfiguration(MimironProperties mimironProperties) {
    ...
    public void init() {
        ...
        if (mimironProperties.getMetrics().getJmx().isEnabled()) {
        ...
        if (mimironProperties.getMetrics().getLogs().isEnabled()) {
            ...
            final Slf4jReporter reporter = Slf4jReporter.forRegistry(metricRegistry)
                ...
                .build();
            reporter.start(mimironProperties.getMetrics().getLogs().getReportFrequency(), TimeUnit.SECONDS);
        }
    }
}
