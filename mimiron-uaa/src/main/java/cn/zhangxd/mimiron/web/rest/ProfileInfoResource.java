...
public class ProfileInfoResource {
    ...
    public ProfileInfoResource(Environment env, MimironProperties mimironProperties) {
        this.env = env;
    ...
    private String getRibbonEnv(String[] activeProfiles) {
        String[] displayOnActiveProfiles = mimironProperties.getRibbon().getDisplayOnActiveProfiles();
