...
public class WebConfigurerTest {
    ...
    private MimironProperties props;
    ...
    public void testStartUpProdServletContext() throws ServletException {
        env.setActiveProfiles(MimironConstants.SPRING_PROFILE_PRODUCTION);
    ...
    public void testStartUpDevServletContext() throws ServletException {
        env.setActiveProfiles(MimironConstants.SPRING_PROFILE_DEVELOPMENT);
        webConfigurer.onStartup(servletContext);
    ...
    public void testUndertowHttp2Enabled() {
        props.getHttp().setVersion(MimironProperties.Http.Version.V_2_0);
        UndertowEmbeddedServletContainerFactory container = new UndertowEmbeddedServletContainerFactory();
        webConfigurer.customize(container);
        Builder builder = Undertow.builder();
        container.getBuilderCustomizers().forEach(c -> c.customize(builder));
