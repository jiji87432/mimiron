...
public class ProfileInfoResourceIntTest {
    ...
    public void setup() {
        ...
        MimironProperties.Ribbon ribbon = new MimironProperties.Ribbon();
        ribbon.setDisplayOnActiveProfiles(mockProfile);
        when(mimironProperties.getRibbon()).thenReturn(ribbon);

        String activeProfiles[] = {"test"};
        when(environment.getDefaultProfiles()).thenReturn(activeProfiles);
        when(environment.getActiveProfiles()).thenReturn(activeProfiles);

        ProfileInfoResource profileInfoResource = new ProfileInfoResource(environment, mimironProperties);
